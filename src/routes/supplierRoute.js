...
router.get("/supplier/view", authenticateToken, isAdmin, supplierController.getAllSupplier);
...
router.get("/supplier/search/:name", authenticateToken, isAdmin, supplierController.searchSupplierByNameParam);
